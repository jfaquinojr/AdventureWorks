...
{
    // ProductSubcategory
    public partial class Production_ProductSubcategoryConfiguration : EntityTypeConfiguration<Production_ProductSubcategory>
    {
        ...
        public Production_ProductSubcategoryConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Production_ProductCategory).WithMany(b => b.Production_ProductSubcategories).HasForeignKey(c => c.ProductCategoryId); // FK_ProductSubcategory_ProductCategory_ProductCategoryID
            InitializePartial();
        }
